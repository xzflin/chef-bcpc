...
if [[ ! -f $BOOTSTRAP_CACHE_DIR/diamond_downloaded ]]; then
  git clone https://github.com/BrightcoveOS/Diamond $BOOTSTRAP_CACHE_DIR/diamond
  touch $BOOTSTRAP_CACHE_DIR/diamond_downloaded
fi
