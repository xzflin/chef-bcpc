...
bash "glance-cirros-image" do
    ...
    code <<-EOH
        ...
        glance image-create --name='Cirros 0.3.2 x86_64' --visibility=public --container-format=bare --disk-format=raw --file /tmp/cirros-0.3.2-x86_64-disk.raw
    EOH
    only_if ". /root/adminrc; glance image-show 'Cirros 0.3.2 x86_64' 2>&1 | grep -e 'No image found with ID Cirros 0.3.2 x86_64'"
end
